...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        /**
         * v1 -> v2: agrega la columna `nombreMesa` a `pedidos`, usada para que el
         * historial y los recibos recuerden el nombre personalizado que tenía la
         * mesa al momento del pedido (ej. "P1", "INT 1"), sin perder los pedidos
         * ya guardados en el dispositivo.
         */
        private val MIGRACION_1_A_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE pedidos ADD COLUMN nombreMesa TEXT")
            }
        }
    }
